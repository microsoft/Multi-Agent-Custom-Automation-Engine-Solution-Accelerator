...
> **For Global Standard | gpt-5.4 - the capacity to at least 50k tokens for optimal performance.**
...
```
gpt-5.4:50,o4-mini:50,gpt-5.4-mini:50
```
### 📌 Default Regions:
```
...
✔️ Check specific model(s) in default regions:
  ```
  ./quota_check_params.sh --models gpt-5.4:50
  ```
...
✔️ Passing Both models and regions:  
  ```
  ./quota_check_params.sh --models gpt-5.4:50 --regions eastus2,westus
  ```
✔️ All parameters combined:
  ```
 ./quota_check_params.sh --models gpt-5.4:50 --regions eastus2,westus --verbose
  ```
✔️ Multiple models with single region:
  ```
 ./quota_check_params.sh --models gpt-5.4:50,gpt-5.4-mini:50 --regions eastus2 --verbose
  ```
