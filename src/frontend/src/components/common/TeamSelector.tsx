...
const TeamSelector: React.FC<TeamSelectorProps> = ({
  ...
  const isDefaultTeam = (team: TeamConfig): boolean => {
    const defaultTeamIds = ['team-1', 'team-2', 'team-3','team-clm-1', 'team-legal-1'];
    const defaultTeamNames = ['Human Resources Team', 'Product Marketing Team', 'Retail Customer Success Team','RFP Team', 'Legal Contract Review Team'];
